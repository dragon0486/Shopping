# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-09-22 11:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.CharField(blank=True, help_text='微信用户绑定和CC视频统计', max_length=64, null=True, unique=True)),
        ...
        migrations.AddField(
            ...
            name='course',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.TCourse'),
        ),
        migrations.AddField(
            model_name='coursedetail',
            name='recommend_courses',
            field=models.ManyToManyField(related_name='rc', to='api.TCourse', verbose_name='推荐课程'),
        ),
        migrations.AddField(
            model_name='course',
            name='degree_course',
        ...
        migrations.AddField(
            model_name='chapter',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.TCourse', verbose_name='所属课程'),
        ),
        migrations.AddField(
