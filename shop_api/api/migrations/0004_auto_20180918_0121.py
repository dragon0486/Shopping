# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-09-17 17:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('api', '0003_degreecourse_pricepolicy_topiccourse'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_detail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.CourseDetail_new')),
            ],
            options={
        ...
        migrations.AlterModelOptions(
            name='degreecourse',
            options={'verbose_name_plural': '03.学位课'},
        ),
        migrations.AlterModelOptions(
            name='pricepolicy',
        ...
        migrations.AlterModelOptions(
            name='topiccourse',
            options={'verbose_name_plural': '06.课程或学位模块详细'},
        ),
        migrations.AddField(
            model_name='degreecourse',
            name='mentor_compensation_bonus',
            field=models.PositiveIntegerField(default=15000, verbose_name='本课程的导师辅导费用(贝里)'),
        ),
        migrations.AddField(
            model_name='degreecourse',
            name='period',
            field=models.PositiveIntegerField(default=150, verbose_name='建议学习周期(days)'),
        ),
        migrations.AddField(
            model_name='degreecourse',
            name='prerequisite',
        ...
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(default=40000, verbose_name='总奖学金(贝里)'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='coursedetail_new',
            name='recommend_courses',
            field=models.ManyToManyField(blank=True, related_name='recommend_by', to='api.TopicCourse'),
        ),
        migrations.AddField(
            model_name='coursedetail_new',
            name='teachers',
        ...
        migrations.AddField(
            ...
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coursechapters', to='api.TopicCourse'),
        ),
        migrations.AddField(
            model_name='article',
            name='source',
