    ...
    <div class="course">
        ...
        <div class="main">
            ...
            <div class="condition">
                <ul class="cate-list">
                    ...
                    <li :class="filter.course_category==item.id?'this':''" v-for="item in category_list"
                        @click="filter.course_category=item.id">{{item.name}}
                    </li>
                </ul>
            ...
            <div class="course-list">
                <div class="course-item" v-for="course in course_list" :key="course.course_img">
                    ...
                    <div class="course-info">
                        <h3>
                            ...
                            <span><img src="@/assets/img/alex_python.png" alt="">{{course.students}}人已加入学习</span></h3>
                        ...
                        <ul class="section-list">
                            <li v-for="(section,key) in course.section_list"><span class="section-title">0{{key+1}}  |  {{section.name}}</span>
...
<script>
    export default {
      ...
      methods:{
        get_category() {
            // 获取课程分类信息
            this.$axios.get(`${this.$settings.BASE_HTTP}/course/categories/`).then(response => {
        ...
        get_course() {
                ...
                // 获取课程列表信息
                this.$axios.get(`${this.$settings.BASE_HTTP}/course/`, {
                    params: filters
                }).then(response => {
